                      ...
                      children: [
                        ...
                        _SettingsSectionCard(
                          ...
                          child: Column(
                            children: [
                              _TestButtonTile(
                                title: 'Test Notifica Semplice',
                                subtitle: 'Notifica base con importance high',
                              ...
                              _TestButtonTile(
                                title: 'Test Programmata (5 sec)',
                                subtitle: 'Notifica tra 5 secondi',
                                icon: Icons.schedule,
                                onTap: () async {
                                  final notificationService = context.read<NotificationService>();
                                  final success = await notificationService.showScheduledTestNotification(seconds: 5);
                                  if (mounted) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(success
                                            ? 'Notifica programmata tra 5 secondi'
                                            : 'Errore: controlla i permessi'),
                                        backgroundColor: success ? const Color(0xFF4CAF50) : const Color(0xFFF44336),
                                        duration: const Duration(seconds: 2),
                                      ),
...
/// Test button tile widget for notification test buttons.
class _TestButtonTile extends StatelessWidget {
  final String title;
  final String subtitle;
  final IconData icon;
  final VoidCallback onTap;

  const _TestButtonTile({
    required this.title,
